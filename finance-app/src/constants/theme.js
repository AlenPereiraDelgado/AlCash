...
export const MODERN_THEMES = {
    dark: {
        ...
        input: 'bg-[#2C2C2E] border border-white/10 text-white placeholder:text-gray-500 outline-none',
    ...
    light: {
        ...
        input: 'bg-gray-100 border border-gray-200 text-black placeholder:text-gray-400 outline-none',
